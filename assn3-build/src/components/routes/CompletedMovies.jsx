...
function CompletedMovies() {
  ...
  const API = `https://film-central-end.vercel.app/completedwatchlist/entries/${id}/${key}`;
  const notesAPI = `https://film-central-end.vercel.app/completedwatchlist/entries/${id}/notes`;
  ...
  async function updateTimesWatched() {
    ...
    const updateAPI = `https://film-central-end.vercel.app/completedwatchlist/entries/${id}/times-watched`
  ...
  async function decrementTimesWatched() {
    const updateAPI = `https://film-central-end.vercel.app/completedwatchlist/entries/${id}/times-watched/decrease`;
  ...
  async function updateRating(newRating) {
    try {
      ...
      const updateAPI = `https://film-central-end.vercel.app/completedwatchlist/entries/${id}/rating`;
      const response = await fetch(updateAPI, {
        method: "PATCH",
        headers: { 
          "Content-Type": "application/json"
