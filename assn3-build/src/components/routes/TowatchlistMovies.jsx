...
function ToWatchListMovies() {
  ...
  const API = `https://film-central-end.vercel.app/towatchlist/entries/${id}/${key}`;
  ...
  async function updatePriority(newPriority) {
    try {
      ...
      const updateAPI = `https://film-central-end.vercel.app/towatchlist/entries/${id}/priority`;
  ...
  async function updateNotes() {
    try {
      const updateAPI = `https://film-central-end.vercel.app/towatchlist/entries/${id}/notes`;
      const response = await fetch(updateAPI, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
