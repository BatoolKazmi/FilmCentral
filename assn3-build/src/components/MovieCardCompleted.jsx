...
function MovieCardCompleted({ movie, id, completedId, apiKey, onRemove }) {
  ...
  async function handleRemove() {
    ...
    const removeFromCompletedListAPI = `https://film-central-backend.vercel.app/completedwatchlist/entries/${completedId}`;
  ...
  async function handleRemoveAndAdd() {
    ...
    try {
      ...
      const response = await axios.post('https://film-central-backend.vercel.app/towatchlist/entries', {
        movieId: id,
        priority: "5",
        notes: "write a note!",
