...
function MovieCardTowatch({ movie, id, Watchlistid, apiKey, onRemove }) {
  ...
  async function handleDelete() {
    ...
    const removeFromPlanningListAPI = `https://film-central-end.vercel.app/towatchlist/entries/${Watchlistid}`;
  ...
  async function handleMarkAsWatched() {
    ...
    const removeFromWatchlistAPI = `https://film-central-end.vercel.app/towatchlist/entries/${Watchlistid}`;
    ...
    const addToCompletedListAPI = "https://film-central-end.vercel.app/completedwatchlist/entries";
    try {
